...
# PRE:recibe un barcoDeTresEspacios el cual es una lista con n elementos y el oceano como una lista de listas
# POST:ubica de forma aleatoria el barcoDeTresEspacios dentro del oceano
