...
def solicitar_nivel_de_dificultad():
    dificultad = int(input("1: NIVEL FACIL (1 al 10), 2:NIVEL INTERMEDIO (1 al 100), 3:NIVEL EXPERTO (1 al 1000) : "))
...
###MAIN
n=1
print("BIENVENIDO AL JUEGO DONDE DEBES ADIVINAR EL NUMERO SECRETO")
